...
document.addEventListener("DOMContentLoaded", () => {
    // ** PATHS DE ASSETS **
    [path_icon_moon, path_icon_moon_dark, path_icon_sun, path_icon_bars, path_icon_bars_dark, path_icon_xmark, path_icon_magnifyng, path_icon_magnifyng_dark, path_chevron_down, path_chevron_down_dark] = ["src/assets/Icons/moon-solid.svg", "src/assets/Icons/moon-solid-dark.svg", "src/assets/Icons/sun-solid.svg", "src/assets/Icons/bars-solid.svg", "src/assets/Icons/bars-solid-dark.svg","src/assets/Icons/xmark-solid.svg", "src/assets/Icons/magnifying-glass-solid.svg", "src/assets/Icons/magnifying-glass-solid-dark.svg", "src/assets/Icons/chevron-down-solid.svg", "src/assets/Icons/chevron-down-solid-dark.svg"]
